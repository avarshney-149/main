...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Email_Deployment_Failures</fullName>
        <description>Email Deployment Failures</description>
        <protected>false</protected>
        <recipients>
            <recipient>lcunningham-bgcy@force.com</recipient>
            <type>user</type>
        </recipients>
    ...
    <alerts>
        <fullName>Send_DC_Email_to_group</fullName>
        <description>Send DC Email to group</description>
        <protected>false</protected>
        <recipients>
            <recipient>lcunningham-bgcy@force.com</recipient>
            <type>user</type>
    ...
    <rules>
        ...
        <actions>
            <name>Send_DC_Email_to_group</name>
            <type>Alert</type>
        </actions>
        <active>false</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>Email Deployment Results</fullName>
        <actions>
            <name>Email_Deployment_Failures</name>
            <type>Alert</type>
        </actions>
        <active>true</active>
        <criteriaItems>
